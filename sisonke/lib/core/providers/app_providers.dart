...
final bootstrapContentServiceProvider = Provider<BootstrapContentService>((ref) {
  final prefs = ref.watch(sharedPreferencesProvider);
  return BootstrapContentService(prefs);
});

final publicContentSyncServiceProvider = Provider<PublicContentSyncService>((ref) {
  final prefs = ref.watch(sharedPreferencesProvider);
