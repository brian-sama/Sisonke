...
void _journalEntrySerialize(
  ...
  writer.writeString(offsets[4], object.moodAtTime);
...
JournalEntry _journalEntryDeserialize(
  ...
  final object = JournalEntry(
    ...
    isarId: id,
    moodAtTime: reader.readStringOrNull(offsets[4]),
...
extension JournalEntryQueryFilter
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      moodAtTimeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'moodAtTime',
        value: value,
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      moodAtTimeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'moodAtTime',
        wildcard: pattern,
...
extension JournalEntryQuerySortBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByIsLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByIsLockedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.desc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByMoodAtTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'moodAtTime', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy>
      sortByMoodAtTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'moodAtTime', Sort.desc);
    });
  }
...
extension JournalEntryQuerySortThenBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByIsLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByIsLockedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.desc);
    });
  }
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByMoodAtTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'moodAtTime', Sort.asc);
    });
  }
...
extension JournalEntryQueryWhereDistinct
  ...
  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByIsLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isLocked');
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByMoodAtTime(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'moodAtTime', caseSensitive: caseSensitive);
    });
  }
...
extension JournalEntryQueryProperty
  ...
  QueryBuilder<JournalEntry, bool, QQueryOperations> isLockedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLocked');
    });
  }

  QueryBuilder<JournalEntry, String?, QQueryOperations> moodAtTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'moodAtTime');
    });
  }
