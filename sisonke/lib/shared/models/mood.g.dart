...
const MoodEntrySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'mood': PropertySchema(
      ...
      name: r'mood',
      type: IsarType.byte,
      enumMap: _MoodEntrymoodEnumValueMap,
    ),
...
MoodEntry _moodEntryDeserialize(
  ...
  final object = MoodEntry(
    energyLevel: reader.readLongOrNull(offsets[0]) ?? 5,
    id: reader.readString(offsets[1]),
    isarId: id,
    mood: _MoodEntrymoodValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        MoodType.great,
...
P _moodEntryDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_MoodEntrymoodValueEnumMap[reader.readByteOrNull(offset)] ??
          MoodType.great) as P;
    case 3:
...
const _MoodEntrymoodEnumValueMap = {
  'great': 0,
  'okay': 1,
  'low': 2,
  'anxious': 3,
...
const _MoodEntrymoodValueEnumMap = {
  0: MoodType.great,
  1: MoodType.okay,
  2: MoodType.low,
  3: MoodType.anxious,
  4: MoodType.angry,
  5: MoodType.overwhelmed,
};
...
extension MoodEntryQueryWhereSort
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhere> anyIsarId() {
...
extension MoodEntryQueryWhere
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
...
extension MoodEntryQueryFilter
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyLevelEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyLevelLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyLevelBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'id',
        value: '',
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdEqualTo(
      Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdGreaterThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdLessThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> isarIdBetween(
    Id? lower,
    Id? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MoodEntryQuerySortBy on QueryBuilder<MoodEntry, MoodEntry, QSortBy> {
  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortByEnergyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyLevel', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortByEnergyLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyLevel', Sort.desc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodEntryQuerySortThenBy
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByEnergyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyLevel', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByEnergyLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyLevel', Sort.desc);
    });
  }
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodEntryQueryWhereDistinct
  ...
  QueryBuilder<MoodEntry, MoodEntry, QDistinct> distinctByEnergyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'energyLevel');
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MoodEntryQueryProperty
  ...
  QueryBuilder<MoodEntry, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<MoodEntry, int, QQueryOperations> energyLevelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'energyLevel');
    });
  }

  QueryBuilder<MoodEntry, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<MoodEntry, MoodType, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
