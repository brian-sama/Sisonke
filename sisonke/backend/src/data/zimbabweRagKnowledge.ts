...
export const zimbabweKnowledgeCards: KnowledgeCard[] = [
  ...
  },
  {
    ...
    category: 'mental-health',
    tags: ['grief', 'loss', 'death', 'bereavement', 'mourning', 'died', 'passed away', 'funeral'],
    riskLevel: 'amber',
    content: 'Grief is a natural and deeply human response to loss — of a person, a relationship, a home, or a future you imagined. In Zimbabwe, grief often carries community and spiritual weight: funerals, chisi (days of rest for the spirit), and the expectations to "be strong" for the family can make personal mourning complicated. There is no timeline for grief. The person does not need to move on or be fixed. Simply acknowledging the loss, naming the person or thing that was lost, and sitting with the weight of it is often the most helpful response. Validate that sadness, anger, numbness, and exhaustion are all normal. If grief involves active thoughts of self-harm or inability to function over extended time, route to Friendship Bench or a counsellor.',
  },
  {
    id: 'zw-financial-stress',
    title: 'Financial Stress and Economic Pressure',
    category: 'wellness',
    tags: ['money', 'financial', 'unemployed', 'no money', 'broke', 'hustle', 'family pressure', 'remittances', 'provide'],
    riskLevel: 'green',
    content: 'Financial stress is one of the most pervasive pressures for young Zimbabweans. The weight of being the one who must provide — for parents, siblings, or extended family — is real and heavy. Unemployment, the informal hustle economy, US dollar costs on local wages, and the pressure of watching peers emigrate all compound this. When a user is in financial distress, validate the systemic nature of the problem ("this is not a personal failure") before offering any coping steps. Avoid generic financial advice. Small manageable actions — one problem at a time, one day at a time — are more useful than big plans. If the person is in immediate danger from debt or family conflict around money, route to a trusted adult or Contact FCC for counselling support.',
  },
];

export const guidanceCards: KnowledgeCard[] = [
  {
    id: 'zw-persona-style',
